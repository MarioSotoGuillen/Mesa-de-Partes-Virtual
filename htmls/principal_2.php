  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">BIENVENIDO A LA MESA VIRTUAL</a>
          <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="resources/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
        <span class="brand-text font-weight-light">USUARIO19</span><i class="bi bi-arrow-left">
      ...
      <div class="sidebar">
        ...
        <div class="resources/user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block"><?= $encabezado2 ?></a>
          </div>
        ...
        <div class="form-inline">
          <div class="resources/input-group" data-widget="sidebar-search">
            <input class="resources/form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search">
            <div class="resources/input-group-append">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0"><?= $encabezado ?></h1>
                  ...
                  <h1> CAMPO OCUPACIONAL

Instituciones públicas y privadas, como empresas de servicio, comerciales y de producción en áreas de mantenimiento (equipos de cómputo), áreas de diseño (publicitario, web), programación. Prestación de servicios y asesorías técnicas en áreas de mantenimiento (equipos de cómputo), áreas de diseño (publicitario, web), programación.</h1>
