...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="resources/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
        <span class="brand-text font-weight-light">USUARIO19</span>
      </a>
    ...
    <table class="table table-striped">
        ...
        <?php   
        foreach ($Reclamos as $l) { ?>
            <tr>
                <td><?=$l['id']?></td>
                <td><?=$l['nombre']?></td>
                <td><?=$l['Apellidos']?></td>
                <td><?=$l['CorreoElectronico']?></td>
                <td><?=$l['Asunto']?></td>
                <td><?=$l['Comentario']?></td>
               
            
                <td>
                    <a href="?accion=editar&id=<?=$l['id']?>">
                        <i class="bi bi-pencil-square"></i> Editar</a>
                    / 
                    <a href="?accion=eliminar&id=<?=$l['id']?>">
